...
class AddUpdateDishActivity : AppCompatActivity(), View.OnClickListener {
                    ...
                    when {
                        TextUtils.isEmpty(mImagePath) -> {
                            Toast.makeText(this@AddUpdateDishActivity
                                , resources.getString(R.string.err_msg_select_dish_img),
                        ...
                        TextUtils.isEmpty(cookingDirection) -> {
                            ...
                            if (dishID == 0){
                                ...
                                Toast.makeText(this@AddUpdateDishActivity,
                                    "You successfully added the dish details.",
                                     Toast.LENGTH_SHORT).show()
                            } else {
                                mFavDishViewModel.update(favDishDetails)
                                Toast.makeText(this@AddUpdateDishActivity,
                                    "You successfully edited dish details",
                                    Toast.LENGTH_SHORT).show()
                            }
    ...
    private fun showRationalDialogForPermissions() {
        AlertDialog.Builder(this).setMessage("It looks like you've turned off permissions required for this feature.")
